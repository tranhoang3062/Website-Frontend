...
export class IndexBComponent {
    ...
    public constructor(private brandService: BrandService, private deleteService: DeleteService, private router: Router, private categoryService: CategoryService, private activatedRoute: ActivatedRoute) {
        this.activatedRoute.queryParamMap.subscribe(params => {
            ...
            if (!this.queryName) {
                ...
                this.brandService.getSearchBrand(this.queryName, (err: boolean, data: any) => {
                    if (!err) {
                        this.dataBrands = data;
                    }
                });
    ...
    public handleDelete(id: number, index: number) {
        ...
        this.deleteService.onDelete(undefined, "", (result: boolean) => {
            if (result) {
                this.brandService.deleteBrand(id, (result: boolean) => {
                    if (result) {
