...
export class EditBComponent {
    ...
    public constructor(private fb: FormBuilder, private router: Router, private brandService: BrandService, private editBrand: EditService, private activatedRoute: ActivatedRoute, private categoryService: CategoryService) {
    ...
    public handleSubmit() {
        ...
        if (!this.nameError) {
            ...
            this.brandService.editBrand(this.paramId, formData, (result: boolean) => {
                if (result) {
