...
export class RegisterComponent {
  ...
  public constructor(private titleService:Title, private fb:FormBuilder, private createService:CreateService, private getService:getService, private router:Router) {
